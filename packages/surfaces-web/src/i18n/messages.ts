...
const zhMessages = {
  ...
  "setup.runtime.description": "配置 OpenAI-Compatible 模型端点，Octopus 会立即进行一次连通性检查。",
  "setup.runtime.provider": "Provider",
...
const enMessages: Record<keyof typeof zhMessages, string> = {
  ...
  "setup.runtime.description": "Configure the OpenAI-compatible runtime endpoint. Octopus will immediately run a connectivity check.",
  "setup.runtime.provider": "Provider",
